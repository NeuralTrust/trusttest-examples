"""Example testing system override attacks using SystemOverrideProbe and InstructionalInversionProbe."""
...
from trusttest.probes import InstructionalInversionProbe, Objective, SystemOverrideProbe
