"""Example testing multi-language attacks using MultiLanguageAttacksProbe with multiple target languages."""
...
from trusttest.probes import MultiLanguageAttacksProbe, Objective
...
probe = MultiLanguageAttacksProbe(
    target=model,
    objectives=[
        Objective(
