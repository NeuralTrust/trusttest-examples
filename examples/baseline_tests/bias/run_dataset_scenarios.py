...
import trusttest
from trusttest.catalog import ContentBiasDatasetScenarioBuilder
...
sub_categories = ContentBiasDatasetScenarioBuilder.sub_categories
for language in languages:
    builder = ContentBiasDatasetScenarioBuilder(
