"""Baseline test for RAG poisoning using RAGProbe with different malicious question types and RAGPoisoningEvaluator."""
...
for question_type in MaliciousQuestion:
    ...
    scenario = EvaluationScenario(
        name=f"RAG Poisoning: RAG {question_type_name}",
