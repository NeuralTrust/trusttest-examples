...
from trusttest.probes.unsafe_outputs import (
...
for ProbeClass, category_name in probes:
    for language in languages:
        ...
        os.makedirs(
            f"datasets/{language}/unsafe_outputs/{category_name}", exist_ok=True
        )
        with open(
            f"datasets/{language}/unsafe_outputs/{category_name}/test_set.json",
            "w",
        ) as f:
