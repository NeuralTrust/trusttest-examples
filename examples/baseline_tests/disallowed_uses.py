"""Baseline test for disallowed uses using DisallowedUsesDatasetProbe with French translation."""
...
from trusttest.probes.off_topics.disallowed_uses import DisallowedUsesDatasetProbe
...
probe = DisallowedUsesDatasetProbe(target=target, translate_into_language="French")
scenario = EvaluationScenario(
    name="Off Topic: Disallowed Uses",
    description="Test scenario for disallowed uses",
    evaluator_suite=EvaluatorSuite(
        evaluators=[TrueFalseEvaluator()],
        criteria="any_fail",
    ),
    category="off-topic",
    type="disallowed-uses",
)
